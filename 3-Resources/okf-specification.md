...
description: Verbatim copy of Google Cloud's official OKF v0.1 spec, kept as a baseline to compare this vault's structure against.
resource: https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/SPEC.md
tags: [okf, reference, spec, vault-structure]
timestamp: 2026-07-06T00:00:00Z
---

> **Provenance.** This is a verbatim copy of Google Cloud's official Open Knowledge Format specification (v0.1 Draft), retrieved 2026-07-06 from
...
> It is stored here unaltered as the canonical baseline for checking this vault (an OKF v0.1 bundle) against the upstream spec. Do not edit the spec text below; if you need to record how this vault diverges, add notes above this line or in a separate concept.
