...
description: Ongoing responsibility for clear shared context, task handoff, and decision visibility between humans and agents.
tags: [area, agents, collaboration, handoff]
timestamp: 2026-07-06T00:00:00Z
standard: A future human or agent can resume meaningful work without hidden context.
---

# Standard

Work should be resumable. Important assumptions, decisions, next actions, and verification results should be written into the vault when they matter beyond the current turn.
